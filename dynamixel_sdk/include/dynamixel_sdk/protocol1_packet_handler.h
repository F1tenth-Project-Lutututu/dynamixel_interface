...
class WINDECLSPEC Protocol1PacketHandler : public PacketHandler
{
 ...
 public:
  ...
  int read10ByteTx(PortHandler *port, uint8_t id, uint16_t address);
  int read10ByteRx(PortHandler *port, uint8_t id, uint8_t *data, uint8_t *error);
  int read10ByteTxRx(PortHandler *port, uint8_t id, uint16_t address, uint8_t *data, uint8_t *error);
};
