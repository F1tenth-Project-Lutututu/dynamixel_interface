...
int Protocol1PacketHandler::read10ByteTx(PortHandler * port, uint8_t id, uint16_t address)
{
  return readTx(port, id, address, 10); // Request to read 10 bytes
}

int Protocol1PacketHandler::read10ByteRx(
...
int Protocol1PacketHandler::read10ByteTxRx(
